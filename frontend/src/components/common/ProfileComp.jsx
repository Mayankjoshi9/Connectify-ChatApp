...
const ProfileComp = (user) => {
  ...
  return (
    ...
    <div className="w-full h-full p-6 rounded-[13px] bg-primary text-white  transition-transform duration-[10000]">
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-gray-300 text-center mb-4">{user.user?.additionalDetails.about}</p>
